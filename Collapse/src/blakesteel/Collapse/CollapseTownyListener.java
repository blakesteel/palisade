 ...
 * @author Palisade
 */
public class CollapseTownyListener extends TownyPlayerListener {
    private Collapse plugin;
    
    static final Logger logger = Logger.getLogger("Minecraft");
    static final String LOG_PREFIX = "[Collapse] ";
    
    public CollapseTownyListener(Towny towny, Collapse plugin) {
        super(towny);
        this.plugin = plugin;
    }
